...
const products: ProductType[] = [
    {
        id: 1,
        section: "MCL",
        link: ['Excellence', 'Learning', 'Creative', 'Sport', 'Career'],
    },
    {
        id: 2,
        section: "Contact",
        link: ['Help/FAQ', 'Enroll', 'Portal', 'Online', 'Social Media']
    }
    ,
    {
        id: 3,
        section: "More",
        link: ['Contact Us', 'Join Us', 'Register Your Kids']
    }
]
        ...
        <div className="mx-auto max-w-2xl sm:pt-24 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
            <div className="my-12 grid grid-cols-1 gap-y-10 sm:grid-cols-6 lg:grid-cols-12">
                ...
                <div className='sm:col-span-6 lg:col-span-5'>
                    ...
                    <h3 className='text-xs font-medium text-gunmetalgray lh-160 mt-5 mb-4 lg:mb-16'> Join us in any of the terms <br /> let your kids enjoy world class learning.</h3>
            ...
            <div className='py-10 md:flex items-center justify-between border-t border-t-gray-blue'>
                <h4 className='text-dark-red opacity-75 text-sm text-center md:text-start font-normal'>@2023.Motessori Careland Schools.All rights reserved</h4>
                <div className="flex gap-5 mt-5 md:mt-0 justify-center md:justify-start">
                    <h4 className='text-dark-red opacity-75 text-sm font-normal'><Link href="/" target="_blank"></Link></h4>
