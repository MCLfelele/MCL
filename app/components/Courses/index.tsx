...
const postData: DataType[] = [
    {
        ...
        imgSrc: '/assets/gallery/pic1.jpg',
    ...
    },
    {
        ...
        heading2: '',
        name: "High Standards",
        imgSrc: '/assets/gallery/pic2.jpg',
            ...
            <div id="courses">
                <div className='mx-auto max-w-7xl sm:py-8 px-4 lg:px-8 '>
                    ...
                    <div className="sm:flex justify-between items-center">
                        <h3 className="text-midnightblue text-4xl lg:text-55xl font-semibold mb-5 sm:mb-0">Why Us.</h3>
                        <Link href={'/'} className="text-Blueviolet text-lg font-medium space-links">Reasons to choose us&nbsp;&gt;&nbsp;</Link>
                    </div>
                                ...
                                <div className='bg-white m-3 px-3 pt-3 pb-12 my-20 shadow-courses rounded-2xl'>
                                    <div className="relative rounded-3xl">
                                        ...
                                        <div className="absolute right-5 -bottom-2 bg-ultramarine rounded-full p-6">
                                            <h3 className="text-white uppercase text-center text-sm font-medium"> Join <br /> Us </h3>
                                        </div>
                                    </div>
